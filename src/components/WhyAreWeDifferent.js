  ...
  return (
    <section id="why-we-different">
      ...
      <h2 className="section-subtitle">
        Arc Media is an advertising and a marketing agency that has come into existence for removing the stereotypes that have been set or
        ...
        Media provide a personalized and customized plan for suiting the different needs of different clients. Our attitude is always
